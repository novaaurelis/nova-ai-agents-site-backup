...
export default function FaqRecoveryEn(){
  return (
    <div>
      <Header/>
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>FAQ & recovery</h1>
            <p className="muted">Skeleton page — actions for incidents and restoring from backups.</p>
          </header>

          <section>
            <h2>Topics</h2>
            <p>Placeholder — quick recovery steps, common issues and backup instructions.</p>
          </section>
