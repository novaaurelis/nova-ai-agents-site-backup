...
export default function UpdateProcedureEn(){
  return (
    <div>
      <Header/>
      <main className="container">
        <article className="module">
          <header className="module-header">
            ...
            <p className="muted">Skeleton page — step-by-step update process, migrations and compatibility checks.</p>
          </header>

          <section>
            <h2>Topics</h2>
            <p>Placeholder — preparation, backups, step-by-step update plan, compatibility tests.</p>
          </section>
