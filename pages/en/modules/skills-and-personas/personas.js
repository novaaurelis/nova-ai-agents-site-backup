...
export default function PersonasPageEn(){
  return (
    <div>
      <Header/>
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>Personas & images</h1>
            <p className="muted">Skeleton page — designing personalities, roles and team interactions for agents.</p>
          </header>
