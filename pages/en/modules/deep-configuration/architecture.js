      ...
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>Architecture & configs</h1>
            <p className="muted">Skeleton page — diagrams, config templates and best practices for agent architecture.</p>
          </header>

          <section>
            <h2>Topics</h2>
            <p>Placeholder — persona design, state storage, config templates and examples.</p>
          </section>
