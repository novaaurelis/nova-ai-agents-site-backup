    ...
    <div>
      ...
      <main className="container">
        <article className="module">
          ...
          <section>
            <h2>What is it</h2>
            <p>OpenClaw is a modern digital assistant — not just a chatbot. While classic chatbots mainly hold conversations, OpenClaw is designed to perform tasks: act on user commands, integrate with external services, use a browser, run automations and drive processes to completion.</p>

            <h3>Not just another chatbot</h3>
            ...
            <h3>Short summary</h3>
            <p>OpenClaw is a digital assistant: it understands requests and helps get work done. From conversation to execution — a step beyond classic chatbots.</p>
