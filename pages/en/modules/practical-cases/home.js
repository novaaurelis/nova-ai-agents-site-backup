...
export default function HomeTasksEn(){
  return (
    <div>
      <Header/>
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>Home tasks</h1>
            <p className="muted">Skeleton page — templates for shopping lists, schedules and automating household routines.</p>
          </header>

          <section>
            <h2>Topics</h2>
            <p>Placeholder — shopping automation, reminders, calendar integrations.</p>
          </section>
