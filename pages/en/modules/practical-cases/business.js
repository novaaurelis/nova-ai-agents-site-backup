...
export default function BusinessCasesEn(){
  return (
    <div>
      <Header/>
      <main className="container">
        <article className="module">
          <header className="module-header">
            ...
            <p className="muted">Skeleton page — sales automation, request handling and competitor monitoring.</p>
          </header>

          <section>
            <h2>Topics</h2>
            <p>Placeholder — CRM integrations, sales pipelines, analytics and notifications.</p>
          </section>
