      ...
      <main className="container">
        <article className="module">
          <header className="module-header">
            ...
            <p className="muted">Скелетная страница — шаблоны для автоматизации задач на работе: сбор данных, рассылки и отчёты.</p>
          </header>

          <section>
            <h2>Темы</h2>
            <p>Placeholder — pipelines, интеграции с API, шаблоны писем и отчётов.</p>
          </section>
