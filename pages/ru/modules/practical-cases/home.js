      ...
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>Домашние задачи</h1>
            <p className="muted">Скелетная страница — шаблоны для планирования покупок, расписаний и автоматизации рутины.</p>
          </header>

          <section>
            <h2>Темы</h2>
            <p>Placeholder — рецепты автоматизации: списки покупок, напоминания, интеграции с календарём.</p>
          </section>
