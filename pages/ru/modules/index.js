  ...
  return (
    <div>
      ...
      <style jsx>{`
        ...
        .container { max-width:980px; margin:18px auto; padding:0 18px; position:relative }
        .container::before{ content:''; position:absolute; left:0; top:12px; bottom:12px; width:8px; background:var(--accent); border-radius:6px }
      `}</style>
    </div>
  )
}
