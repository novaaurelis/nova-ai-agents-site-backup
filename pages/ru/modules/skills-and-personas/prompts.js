      ...
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>Промт‑инжениринг</h1>
            <p className="muted">Скелетная страница — шаблоны промтов, техники детального инструктажа и отладки поведения.</p>
          </header>

          <section>
            <h2>Темы</h2>
            <p>Placeholder — prompt templates, stepwise refinement, testing and error handling.</p>
          </section>
