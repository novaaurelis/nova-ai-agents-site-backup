      ...
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>Установка OpenClaw на Windows</h1>
            <p className="muted">Пошаговое руководство по установке цифрового ассистента на Windows.</p>
            <p className="muted">Лучше всего выполнять все действия через PowerShell или Windows Terminal. Команды готовы к копированию.</p>
          </header>

          <section className="steps">
            <div className="step">
              <div className="step-header"><h3>Шаг 1. Проверяем системные требования</h3></div>
              <ul>
                <li>Windows 10/11 64-bit</li>
                <li>Права администратора для установки программ</li>
                <li>Установленный Windows Terminal или обычный PowerShell</li>
                <li>Достаточно свободного места на диске (300–500 МБ)</li>
                <li>Если планируете запускать локальные языковые модели, желательно иметь от 8 ГБ ОЗУ, а лучше 16 ГБ и больше</li>
                <li>Для локальных моделей очень желательно SSD и стабильное интернет-соединение для первичной установки компонентов</li>
              </ul>
              <p>⚠️ Если у вас ещё не установлены Git, Node.js и другие зависимости, мы сейчас всё поставим.</p>
              <p style={{margin:0,height:'14px'}}></p>
            </div>

            <div className="step">
              <div className="step-header"><h3>Шаг 2. Устанавливаем Git</h3></div>
              <p>Git нужен для установки и обновления компонентов OpenClaw.<br/>Скачать можно с официального сайта: <a href="https://git-scm.com/download/win">https://git-scm.com/download/win</a></p>
              <p>Если на компьютере есть <code>winget</code>, можно установить Git одной командой:</p>
              <CodeBlock>{`winget install --id Git.Git -e --source winget`}</CodeBlock>
              <p>После установки проверьте версию Git:</p>
              <CodeBlock>{`git --version`}</CodeBlock>
              <p style={{margin:0,height:'14px'}}></p>
            </div>

            <div className="step">
              <div className="step-header"><h3>Шаг 3. Устанавливаем Node.js и менеджер версий</h3></div>
              <p>Официальный сайт Node.js: <a href="https://nodejs.org/en/download">https://nodejs.org/en/download</a></p>
              <p>На Windows удобнее всего использовать <strong>nvm-windows</strong> — это менеджер версий Node.js для Windows.</p>
              <p>Сначала установите nvm-windows, затем Node.js 24:</p>
              <CodeBlock>{`# Скачайте nvm-windows с официальной страницы релизов:
https://github.com/coreybutler/nvm-windows/releases

# После установки nvm выполните в PowerShell:
nvm install 24
nvm use 24
...
npm -v
`}</CodeBlock>
              <p>Если не хотите использовать nvm-windows, можно установить Node.js напрямую через winget:</p>
              <CodeBlock>{`winget install OpenJS.NodeJS.LTS`}</CodeBlock>
              <div className="note" role="note" aria-label="Примечание">
                ⚠️ Если команды установки или версии изменились, проверьте актуальные инструкции на официальных сайтах Git и Node.js.
              </div>
              <p style={{margin:0,height:'14px'}}></p>
            </div>

            <div className="step">
              <div className="step-header"><h3>Шаг 4. (Опционально) Устанавливаем Bun</h3></div>
...
openclaw onboard --install-daemon`}</CodeBlock>
            ...
            <div className="step">
              ...
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <div className="figure small"><img src="/images/ollama_window.png" alt="Ollama window" className="responsive ollama-small"/></div>
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              ...
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <div className="figure small"><img src="/images/telegram_window.png" alt="Telegram window" className="responsive telegram-small"/></div>
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              ...
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <div className="figure small"><img src="/images/telegrambot_setup.png" alt="Telegram bot setup" className="responsive telegrambot-half"/></div>
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              ...
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <div className="figure small"><img src="/images/skills_window.png" alt="Skills window" className="responsive skills-small"/></div>
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              ...
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <div className="figure small"><img src="/images/hatch_window.png" alt="Interface selection window" className="responsive hatch-small"/></div>
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <ul>
              ...
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
              <div className="figure small"><img src="/images/b3huwmir.jpg" alt="OpenClaw web session" className="responsive websession-small"/></div>
              <p style={{margin:0,height:'14px'}}></p>
              <p style={{margin:0,height:'14px'}}></p>
        ...
        <style jsx>{`\n          .module{--step-highlight-width:650px;max-width:720px !important;box-sizing:border-box;margin:12px auto;padding:0 18px 100px;overflow-wrap:break-word}
          ...
          .module-header{margin-bottom:0;text-align:left}
          ...
          .module-header h1{margin:0;font-size:28px;line-height:1;text-align:left}
          .module-header p{margin:0;padding:0;line-height:1.35;margin-top:4px;text-align:left} .module-header h1 + p{margin-top:6px;padding-top:0}
          ...
          .figure{margin:8px 0;display:flex;justify-content:center;align-items:center}
          ...
          .image-grid{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;margin:8px 0}
          .figure.small{display:flex;justify-content:center;align-items:center}
          .figure.small img{max-width:480px;margin:0 auto;display:block}
          .telegram-small{max-width:340px !important;width:100%;}
          .telegrambot-half{max-width:340px !important;width:100%;}
          .skills-small{max-width:360px !important;width:100%;}
          .hatch-small{max-width:360px !important;width:100%;}
          .websession-small{max-width:420px !important;width:100%;}
          .ollama-small{max-width:360px !important;width:100%;}
