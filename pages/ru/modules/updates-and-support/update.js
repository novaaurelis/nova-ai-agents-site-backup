      ...
      <main className="container">
        <article className="module">
          <header className="module-header">
            ...
            <p className="muted">Скелетная страница — порядок обновлений, миграции и проверки совместимости.</p>
          </header>

          <section>
            <h2>Темы</h2>
            <p>Placeholder — подготовка, бэкапы, пошаговый план обновления, тесты совместимости.</p>
          </section>
