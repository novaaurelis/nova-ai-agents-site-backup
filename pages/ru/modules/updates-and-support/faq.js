...
export default function FaqRecovery(){
  return (
    <div>
      <Header/>
      <main className="container">
        <article className="module">
          <header className="module-header">
            <h1>FAQ и восстановление</h1>
            <p className="muted">Скелетная страница — действия при ошибках и восстановление из резервных копий.</p>
          </header>

          <section>
            <h2>Темы</h2>
            <p>Placeholder — советы по быстрым восстановлением, common issues и инструкции по бэкапам.</p>
          </section>
