      ...
      <main className="container">
        ...
        <section className="models" aria-label="Модели">
          ...
          <div style={{display:'flex',justifyContent:'center',marginTop:12}}>
            <img src="/images/neurologos_background2_trans.png" alt="neurologos background" className="popular-illustration" style={{maxWidth:'100%',height:'auto',background:'transparent'}} />
          </div>
        </section>
