  ...
  return (
    <div style={{position:'relative',margin:'12px 0'}}>
      ...
      <button onClick={handleCopy} aria-label={copied? 'Copied' : 'Copy code'}
        style={{position:'absolute',right:10,top:10,padding:'6px 8px',borderRadius:8,background: copied? 'var(--accent)' : 'rgba(255,255,255,0.06)',color: copied? 'white' : 'var(--accent)',border:'1px solid rgba(255,255,255,0.06)',cursor:'pointer',display:'flex',alignItems:'center',gap:8}}>
        {copied ? (
